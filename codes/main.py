...
from model import AppPreUserIdenGtr, AppPreLocPreUserIdenGtr, AppPreLocPreGtr, AppPreLocUserIdenGtr
...
from model import AppPreLocPreUserIdenGtrLinear
...
def parse_args():
	...
	parser.add_argument('--uid_emb_size', type=int, default=256, help="user id embeddings size")
	...
	parser.add_argument('--data_name', type=str, default='telecom_4_10_0.8_8_24_1000_exist_Appnumber2000_Locnumber0_compress_30min_tencent_App1to2000_basef0.pk')
...
if __name__ == '__main__':
	...
	os.environ["CUDA_VISIBLE_DEVICES"] = str(a[0])
